        ...
        switch ( *output_state)
        {
               ...
               *output_state  = preamblelen_set(*lora_buf_size,*new_data_available,rx_buf,configdata,current_index);
                ...
                *output_state  = tx_timeout_set(*lora_buf_size,*new_data_available,rx_buf,configdata,current_index,&Stage);
                ...
                case AUTHENTICATION_KEY_SET:

                stringg = "AUTHENTICATION_KEY_SET\n";
                testcase(stringg);

                *output_state  = authenticcation_key_set(*lora_buf_size,*new_data_available,rx_buf,configdata,current_index);
                break;
                ...
                stringg = "NODE_ADDRESS_SET\n";
                testcase(stringg);

                *output_state = address_key_set(*lora_buf_size,*new_data_available,rx_buf,configdata,current_index);
