...
typedef enum {
    ...
    TAKE_DATA_FROM_SENSORS_OPERATION_STATE,
    REMOVE_FLASH_BUTTON_PRESSED_OPERATION_STATE,


    SEND_DATA_THROUGH_LORA_OPERATION_STATE, /// keep
 


    DONOTHING_OPERATION_STATE ,     

    GO_TO_SLEEP_OPERATION_STATE,

    TX_TIMEOUT_OPERATION_STATE ,
