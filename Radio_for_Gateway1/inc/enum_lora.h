...
typedef enum {
    ...
    REMOVE_FLASH_HAPPENING,
    WAITING_SEND_DATA_THROUGH_LORA,
    SEND_DATA_THROUGH_LORA,
    DEALING_WITH_DOWNLINK_INPUT_IF_IT_HAVE_RIGHT_FORMAT_OR_NOT,//
    LISTEN,
    DONOTHING , 
    REICEIVED,
    PREPARE_DATA_ACK_SEND_TO_NODE,
    TAKE_COMMANDS_FROM_UART,
    CHECK_AES_KEY,
    SYNCH_AES_KEY
}Operation_state_t;
...
typedef enum{
    ...
    TRASH,  // meaning it is not error or timeout payload 
    RX_ERROR,
    RX_TIMEOUT_NOTIFY,
    TX_ERROR,
    TX_TIMEOUT_NOTIFY, 
